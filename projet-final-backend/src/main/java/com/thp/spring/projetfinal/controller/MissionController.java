...
public class MissionController {
	...
	public MissionDTO addMission(@RequestBody MissionDTO missionDTO) {
		Set<TacheMissionDTO> tacheMissionDTOs = new HashSet<TacheMissionDTO>();
		...
		for (TacheModeleDTO tacheModeleDTO : tacheModeleDTOs) {
			...
			// tacheMissionDTO.setStatus(tacheModeleDTO.getStatus());
...
//	@GetMapping(value = "/mission/{description}")
//	public MissionDTO getByDescription(@PathVariable String description) {
//		System.out.println(description);
//		System.out.println(missionService.findByDescription(description));
//		return missionService.findByDescription(description);
//	}
	...
	public MissionDTO updateUser(@RequestBody MissionDTO missionDTO) {
		...
		System.out.println(missionDTO.getTachesMissions());
		return missionService.addMission(missionDTO);
	}
